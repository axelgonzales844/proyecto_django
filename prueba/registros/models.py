...
class Alumnos(models.Model): #Define la estrcutura de nuestratabla
    ...
    def __str__(self):
        return self.nombre
       #inidca que se mostrara el nombre como valor en la tabla
...
class Comentario(models.Model):
    ...
    class Meta:verbose_name = "Comentario"
